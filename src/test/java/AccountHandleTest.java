...
//    private SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
    ...
    public void shouldReturn1000Emprunt0DepotWhen1000Emprunt0Depot() throws ParseException {
        Emprunt emprunt = FunctionForTest.emprunter(shmuelPersonne, BigDecimal.valueOf(1000), shekelDevise, dateFormat.parse("01/07/2018", formatter), dateFormat.parse("01/10/2018", formatter),personneRepository, empruntRepository);
    ...
    public void shouldReturn1000Emprunt1000DepotWhen1000Emprunt1000Depot() throws ParseException {
        Emprunt emprunt = FunctionForTest.emprunter(shmuelPersonne, BigDecimal.valueOf(1000), shekelDevise, dateFormat.parse("01/07/2018", formatter), dateFormat.parse("01/10/2018", formatter),personneRepository, empruntRepository);
        Depot depot = FunctionForTest.deposer(shmuelPersonne, BigDecimal.valueOf(1000), shekelDevise, dateFormat.parse("01/07/2018", formatter),personneRepository, depotRepository);
        assertEquals(BigDecimal.valueOf(1000),shmuelPersonne.getAccount().getEmpruntAmount());
    ...
    public void shouldReturn1000DepotWhen2000Depot1000Retrait() throws ParseException, RetraitImpossibleException {
        Depot depot = FunctionForTest.deposer(shmuelPersonne, BigDecimal.valueOf(2000), shekelDevise, dateFormat.parse("01/07/2018", formatter),personneRepository, depotRepository);
        Retrait retrait = FunctionForTest.retirer(shmuelPersonne,BigDecimal.valueOf(1000), shekelDevise, dateFormat.parse("01/07/2018", formatter),personneRepository, retraitRepository);
        assertEquals(BigDecimal.valueOf(1000),shmuelPersonne.getAccount().getDepotAmount());
    }
    ...
    public void shouldReturnErrorWhen1000Depot2000Retrait() throws ParseException, RetraitImpossibleException {
        Depot depot = FunctionForTest.deposer(shmuelPersonne, BigDecimal.valueOf(1000), shekelDevise, dateFormat.parse("01/07/2018", formatter),personneRepository, depotRepository);
        Retrait retrait = FunctionForTest.retirer(shmuelPersonne,BigDecimal.valueOf(2000), shekelDevise, dateFormat.parse("01/07/2018", formatter),personneRepository, retraitRepository);
    }
